...
Public Class DOPsPlot
    ...
    Private Sub DOPsPlot_Paint(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles Me.Paint
        ...
        With e.Graphics
            ...
            Dim Saty As Decimal = ScreenBasePt1(1) + drawingAreaHeight - DOP_Data.data(1, 2) * PosScaleY1
            ...
            For i = 1 To DOP_Data.nRows - 6
                ...
                End If
                drawingY1 = (ScreenBasePt1(1) + drawingAreaHeight) - DOP_Data.data(i, 2) * PosScaleY1
            ...
            For i = highestY4 To lowestY4 Step -1 * lineOffsetY
                .DrawString(Decimal.Round(DOP_Data.data(DOP_Data.nRows, 2) + k * lineOffsetY / PosScaleY4, 1), axisFont, Brushes.Black, ScreenBasePt4(0) - 20, i + 8, string_format2)
                k += 1
            Next

            k = 0
            For i = highestY3 To lowestY3 Step -1 * lineOffsetY
                .DrawString(Decimal.Round(DOP_Data.data(DOP_Data.nRows - 1, 2) + k * lineOffsetY / PosScaleY3, 1), axisFont, Brushes.Black, ScreenBasePt4(0) - 20, i + 8, string_format2)
                k += 1
            Next

            k = 0
            For i = highestY2 To lowestY2 Step -1 * lineOffsetY
                .DrawString(Decimal.Round(DOP_Data.data(DOP_Data.nRows - 2, 2) + k * lineOffsetY / PosScaleY2, 1), axisFont, Brushes.Black, ScreenBasePt4(0) - 20, i + 8, string_format2)
                k += 1
            Next

            k = 0
            For i = highestY1 To lowestY1 Step -1 * lineOffsetY
                .DrawString(k.ToString, axisFont, Brushes.Black, ScreenBasePt1(0) - 20, i + 8, string_format2)
                k += 2
            Next

            .DrawString("GPS Time (s)", axisFont, Brushes.Black, ScreenBasePt1(0) + drawingAreaWidth / 2, highestY4 + 40, string_format1)

            .DrawString("Plot of Computed DOP values during Observation Period", textFont, Brushes.Black, ScreenBasePt1(0) + drawingAreaWidth / 2, 15, string_format1)
            .DrawString("Using a " & elevAngle.ToString & Chr(176) & " Elevation Mask", axisFont, Brushes.Black, ScreenBasePt1(0) + drawingAreaWidth / 2, 35, string_format1)

            .ResetTransform()
            .RotateTransform(-90)
            .TranslateTransform(-1 * (ScreenBasePt1(1) + drawingAreaHeight / 2), 40)
            .DrawString("# of Sats", axisFont, Brushes.Black, 0, 0, string_format1)

            .ResetTransform()
            .RotateTransform(-90)
            .TranslateTransform(-1 * (ScreenBasePt2(1) + drawingAreaHeight / 2), 40)
            .DrawString("PDOP", axisFont, Brushes.Black, 0, 0, string_format1)

            .ResetTransform()
            .RotateTransform(-90)
            .TranslateTransform(-1 * (ScreenBasePt3(1) + drawingAreaHeight / 2), 40)
            .DrawString("HDOP", axisFont, Brushes.Black, 0, 0, string_format1)

            .ResetTransform()
            .RotateTransform(-90)
            .TranslateTransform(-1 * (ScreenBasePt4(1) + drawingAreaHeight / 2), 40)
            .DrawString("VDOP", axisFont, Brushes.Black, 0, 0, string_format1)
